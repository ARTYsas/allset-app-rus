      ...
      <DialogContent className="sm:max-w-[800px]">
        <DialogHeader>
          <DialogTitle className="flex items-center">
            ...
            Select Invoices for Receipts
          </DialogTitle>
        </DialogHeader>
        
        <div className="py-4">
          <p className="text-sm text-muted-foreground mb-4">
            Select the invoices you want to create receipts for. Only non-paid invoices are shown.
          </p>
            ...
            <div>
              ...
              <div className="flex justify-between items-center mt-4">
                <div className="text-sm">
                  Selected: {selectedInvoiceIds.length} of {invoices.length} invoices
                </div>
